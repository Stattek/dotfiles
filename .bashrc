...
# --- MY ALIASES ---
# alias for changing directories with fzf
...
function trim-ig-watermark() {
	...
	echo "Usage: trim-watermark <input_video> <output_video>"
    else
	INPUT_VIDEO="$1"
	OUTPUT_VIDEO="$2"
	...
	OUTPUT_DURATION=$(bc <<<"$INPUT_VIDEO_LENGTH"-"$ENDING_WATERMARK_LENGTH")
